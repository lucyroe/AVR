...
for model in models:
    ...
    for state in range(number_of_states):
        ...
        summary_stats["mean"] = summary_stats_all_subjects[summary_stats_all_subjects["state"] == state].groupby("feature")["mean"].mean()
        summary_stats["std"] = summary_stats_all_subjects[summary_stats_all_subjects["state"] == state].groupby("feature")["std"].mean()
        # Calculate the minimum and maximum for each feature
        summary_stats["min"] = summary_stats_all_subjects[summary_stats_all_subjects["state"] == state].groupby("feature")["min"].mean()
        summary_stats["max"] = summary_stats_all_subjects[summary_stats_all_subjects["state"] == state].groupby("feature")["max"].mean()
